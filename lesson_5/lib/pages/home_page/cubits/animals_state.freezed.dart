...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is AnimalsState&&const DeepCollectionEquality().equals(other.animals, animals));
}
...
@override
String toString() {
  return 'AnimalsState(animals: $animals)';
}
...
class _AnimalsState extends AnimalsState {
  const _AnimalsState({final  List<Animal> animals = const []}): _animals = animals,super._();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _AnimalsState&&const DeepCollectionEquality().equals(other._animals, _animals));
}
